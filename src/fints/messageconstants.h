...
const char SEGMENT_TRANSACTIONS_REQUEST_VERSION[] = "7";
const char SEGMENT_TRANSACTIONS_RESPONSE_ID[] = "HIKAZ";
const char SEGMENT_TRANSACTIONS_RESPONSE_VERSION[] = "7";
const char SEGMENT_TRANSACTIONS_PARAMETERS_ID[] = "HIKAZS";
const char SEGMENT_PORTFOLIO_INFO_REQUEST_ID[] = "HKWPD";
const char SEGMENT_PORTFOLIO_INFO_REQUEST_VERSION[] = "6";
const char SEGMENT_PORTFOLIO_INFO_RESPONSE_ID[] = "HIWPD";
const char SEGMENT_PORTFOLIO_INFO_RESPONSE_VERSION[] = "6";
const char SEGMENT_PORTFOLIO_PARAMETERS_ID[] = "HIWPDS";
